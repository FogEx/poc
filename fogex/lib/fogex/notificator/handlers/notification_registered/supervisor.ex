defmodule FogEx.Notificator.NotificationRegistered.Supervisor do
  use Supervisor

  alias FogEx.Notificator.NotificationRegistered.Handler, as: NotificationRegisteredHandler
